...
async function sendAbandonedCartEmail(email, name) {
  ...
  const body =
    ...
    `<p><a href="https://cherrysage.com/shop" style="display:inline-block;background:#6E1A28;color:#fff;text-decoration:none;padding:11px 22px;border-radius:8px;font-family:Georgia,'Times New Roman',serif;font-size:14px;font-weight:600;">Complete your purchase</a></p>` +
