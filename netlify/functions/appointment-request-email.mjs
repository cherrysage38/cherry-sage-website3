...
export default async (req) => {
  ...
  const body =
    ...
    `<p>This is a request, not an instant booking, so your exact time isn't confirmed yet. Cherry reviews it and will confirm, offer an alternate time, or follow up directly by email or phone. Most readings take place the same day.</p>` +
